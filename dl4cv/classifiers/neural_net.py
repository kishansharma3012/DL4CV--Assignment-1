...
class TwoLayerNet(object):
    ...
    def train(self, X, y, X_val, y_val,reg=1e-5,
        ...
        for it in xrange(num_iters):
            ...
            r_id = np.random.choice(temp,batch_size,replace=True)
            X_batch = X[r_id,:]
            y_batch = y[r_id]
            #########################################################################
            #                             END OF YOUR CODE                          #
    ...
    def predict(self, X):
        ...
        score = hidden_ReLu.dot(self.params['W2']) + self.params['b2']
